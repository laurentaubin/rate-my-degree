  ...
  return (
    <>
      <Flex width="100%" zIndex={-1} position="absolute">
        <HomePageBlob marginLeft="auto" marginRight={[0, 0, 0, "15vw"]} />
      </Flex>
      <Flex height="20vh" paddingTop="4vh">
        ...
        <GoogleLogin marginLeft="auto" marginRight={[5, 5, "25vw"]} backgroundColor="black" color="white" _hover={{}} />
      </Flex>
    </>
  );
};
